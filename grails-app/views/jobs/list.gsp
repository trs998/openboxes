...
<head>
    ...
    <title><warehouse:message code="default.jobs.label" default="Job" /></title>
</head>
<body>
<div class="body">
                ...
                <table>
                    ...
                    <g:each in="${jobKeys}" status="i" var="jobKey">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            <td>
                                <g:link controller="jobs" action="show" id="${jobKey.name} params="[group:jobKey.group]" >${jobKey}</g:link>
                            </td>
                            <td>
                                ${jobKey.properties}
                            </td>
