...
<div id="footer">
	<div style="line-height: 2em;" class="center middle">
        ...
        <g:message code="application.buildNumber.label" default="SHA"/>: <b><a href="https://github.com/openboxes/openboxes/commit/${gitProperties?.commitId}">${gitProperties?.shortCommitId}</a></b>&nbsp;&nbsp; | &nbsp;&nbsp;
